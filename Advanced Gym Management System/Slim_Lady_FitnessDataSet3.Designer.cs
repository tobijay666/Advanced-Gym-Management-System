...
SELECT cId, cName, cAge, cNIC, cPno, cAddress, cJdate, cEcont, [height(cm)], [weight(Kg)], bmi, breast, waist, hips, mID, wID FROM Customer WHERE (cId = @cId)";
        ...
        public virtual int Fill(Slim_Lady_FitnessDataSet3.CustomerDataTable dataTable) {
        ...
        public virtual Slim_Lady_FitnessDataSet3.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Slim_Lady_FitnessDataSet3.CustomerDataTable dataTable = new Slim_Lady_FitnessDataSet3.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Slim_Lady_FitnessDataSet3.CustomerDataTable dataTable) {
