...
namespace Advanced_Gym_Management_System {
    ...
    public partial class Slim_Lady_FitnessDataSet2 : global::System.Data.DataSet {
        ...
        public partial class PaymentDataTable : global::System.Data.TypedTableBase<PaymentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PaymentRow AddPaymentRow(System.DateTime pDate, int pAmount) {
    ...
    public partial class PaymentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Payment] WHERE (([pId] = @Original_pId) AND ([pDate] = @Origin" +
                "al_pDate) AND ([pAmount] = @Original_pAmount))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Payment] ([pDate], [pAmount]) VALUES (@pDate, @pAmount);\r\nSELE" +
                "CT pId, pDate, pAmount FROM Payment WHERE (pId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Payment] SET [pDate] = @pDate, [pAmount] = @pAmount WHERE (([pId] =" +
                " @Original_pId) AND ([pDate] = @Original_pDate) AND ([pAmount] = @Original_pAmou" +
                "nt));\r\nSELECT pId, pDate, pAmount FROM Payment WHERE (pId = @pId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT pId, pDate, pAmount FROM dbo.Payment";
        ...
        public virtual int Fill(Slim_Lady_FitnessDataSet2.PaymentDataTable dataTable) {
        ...
        public virtual Slim_Lady_FitnessDataSet2.PaymentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Slim_Lady_FitnessDataSet2.PaymentDataTable dataTable = new Slim_Lady_FitnessDataSet2.PaymentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Slim_Lady_FitnessDataSet2.PaymentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_pId, System.DateTime Original_pDate, int Original_pAmount) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_pAmount));
        ...
        public virtual int Insert(System.DateTime pDate, int pAmount) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((System.DateTime)(pDate));
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(pAmount));
        ...
        public virtual int Update(System.DateTime pDate, int pAmount, int Original_pId, System.DateTime Original_pDate, int Original_pAmount, int pId) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((System.DateTime)(pDate));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(pAmount));
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Original_pId));
            this.Adapter.UpdateCommand.Parameters[3].Value = ((System.DateTime)(Original_pDate));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_pAmount));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime pDate, int pAmount, int Original_pId, System.DateTime Original_pDate, int Original_pAmount) {
            return this.Update(pDate, pAmount, Original_pId, Original_pDate, Original_pAmount, Original_pId);
        }
    }
