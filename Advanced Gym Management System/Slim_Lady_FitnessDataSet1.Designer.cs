...
namespace Advanced_Gym_Management_System {
    ...
    public partial class Slim_Lady_FitnessDataSet1 : global::System.Data.DataSet {
        ...
        public partial class PaymentDataTable : global::System.Data.TypedTableBase<PaymentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PaymentRow AddPaymentRow(System.DateTime pDate, int cId, int pAmount) {
        ...
        public partial class PaymentRow : global::System.Data.DataRow {
            ...
            public int pAmount {
                get {
                    return ((int)(this[this.tablePayment.pAmountColumn]));
                }
                set {
            ...
            public bool IscIdNull() {
                return this.IsNull(this.tablePayment.cIdColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetcIdNull() {
                this[this.tablePayment.cIdColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Advanced_Gym_Management_System.Slim_Lady_FitnessDataSet1TableAdapters {
    ...
    public partial class PaymentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Payment] WHERE (([pId] = @Original_pId) AND ([pDate] = @Origin" +
                "al_pDate) AND ((@IsNull_cId = 1 AND [cId] IS NULL) OR ([cId] = @Original_cId)) A" +
                "ND ([pAmount] = @Original_pAmount))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Payment] ([pDate], [cId], [pAmount]) VALUES (@pDate, @cId, @pA" +
                "mount);\r\nSELECT pId, pDate, cId, pAmount FROM Payment WHERE (pId = SCOPE_IDENTIT" +
                "Y())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Payment] SET [pDate] = @pDate, [cId] = @cId, [pAmount] = @pAmount WHERE (([pId] = @Original_pId) AND ([pDate] = @Original_pDate) AND ((@IsNull_cId = 1 AND [cId] IS NULL) OR ([cId] = @Original_cId)) AND ([pAmount] = @Original_pAmount));
SELECT pId, pDate, cId, pAmount FROM Payment WHERE (pId = @pId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT pId, pDate, cId, pAmount FROM dbo.Payment";
        ...
        public virtual int Fill(Slim_Lady_FitnessDataSet1.PaymentDataTable dataTable) {
        ...
        public virtual Slim_Lady_FitnessDataSet1.PaymentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Slim_Lady_FitnessDataSet1.PaymentDataTable dataTable = new Slim_Lady_FitnessDataSet1.PaymentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Slim_Lady_FitnessDataSet1.PaymentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_pId, System.DateTime Original_pDate, global::System.Nullable<int> Original_cId, int Original_pAmount) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_pAmount));
        ...
        public virtual int Insert(System.DateTime pDate, global::System.Nullable<int> cId, int pAmount) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(pAmount));
        ...
        public virtual int Update(System.DateTime pDate, global::System.Nullable<int> cId, int pAmount, int Original_pId, System.DateTime Original_pDate, global::System.Nullable<int> Original_cId, int Original_pAmount, int pId) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(pAmount));
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_pId));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((System.DateTime)(Original_pDate));
            if ((Original_cId.HasValue == true)) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_pAmount));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime pDate, global::System.Nullable<int> cId, int pAmount, int Original_pId, System.DateTime Original_pDate, global::System.Nullable<int> Original_cId, int Original_pAmount) {
            return this.Update(pDate, cId, pAmount, Original_pId, Original_pDate, Original_cId, Original_pAmount, Original_pId);
        }
    }
